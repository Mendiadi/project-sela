...
class CheckOutPage(BasePage):
    ...
    def checkout_and_complete_purchase(self):
        step_1_layer = self.driver.locate_element(self._locators['checkout_step_layer'])
        self.driver.locate_element(self._locators['checkout_step_btn'], step_1_layer).click()
        self.driver.locate_element(self._locators['checkout_step_1_btn']).click()
        self.driver.locate_element(self._locators['checkout_checker_btn']).click()
        self.driver.locate_element(self._locators['checkout_step_2_btn']).click()
        ...
        cofirm_class = self.driver.locate_element(self._locators['confirm_btn_class'])
        self.driver.locate_element(self._locators['confirm_btn'], cofirm_class).click()
